...
struct pilotBookingDetails: View {
    var body: some View {
        NavigationStack{
            VStack{
                ZStack{
                    ...
                    */
                    VStack(alignment: .leading){
                        ...
                        VStack(alignment:.leading){
                            ...
                            Text("lorem ipsum fjuivjj  slkjvnivnvin dsvnsiv vc djnv ijvnj vvv dnvnv gefijgvneriuvnivn fdjnvefrv vsvsvsvkndsjkhvjsknv dsvndvn").font(.system(size: 16, weight: .bold)).foregroundColor(Color(#colorLiteral(red: 0.1, green: 0.11, blue: 0.12, alpha: 1))).tracking(1)
                        }.padding(.top)
                    ...
                    Divider()
                    VStack(alignment: .leading){
                        Text("Client").font(.system(size: 17, weight: .bold))
                            .kerning(1)
                            .multilineTextAlignment(.center)
                            .foregroundColor(Color(red: 0.23, green: 0.83, blue: 0.65))
                        HStack{
